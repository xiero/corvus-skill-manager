  ...
  return (
    <Box flexDirection="column" gap={1}>
      ...
      <Box flexDirection="column">
        ...
        <Text>1. Setup Skillpack: preview, then confirm the initial clone when checkout is missing.</Text>
      ...
      <Box flexDirection="column">
        ...
        <Text>Status shows configured state, selected skills, commits, dirty state, and link count.</Text>
        <Text>Doctor explains missing config, registry/SKILL.md issues, broken links, and conflicts.</Text>
        <Text>The manager never repairs, pulls, resets, or edits the skillpack checkout from these views.</Text>
      </Box>
