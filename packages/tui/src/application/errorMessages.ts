...
const messagesByCode: Record<MachineErrorCode, string> = {
  ...
  BUNDLE_NOT_SUPPORTED_BY_AGENT: 'That bundle is not compatible with the selected agent.',
  BUNDLE_MEMBER_MISMATCH: 'That bundle contains a member that is unavailable or invalid.',
  VERSION_MISMATCH: 'The active skillpack does not satisfy a required version constraint.',
